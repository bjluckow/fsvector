...
// 	Extract(ctx context.Context, fi source.FileInfo) ([]*job, error)
// }
...
// func (e *ImageExtractor) Extract(ctx context.Context, fi source.FileInfo) ([]*job, error) {
...
// 	imageItemID, err := store.UpsertItem(ctx, fileID, model.Item{
// 		ItemType:    "image",
// 		ItemName:    fi.Name,
// 		MimeType:    fi.MimeType,
// 		Size:        fi.Size,
...
// func (e *TextExtractor) Extract(ctx context.Context, fi source.FileInfo) ([]*job, error) {
// 	data, err := e.Reader.Read(ctx, fi.Path)
// 	if err != nil {
// 		return nil, fmt.Errorf("read %s: %w", fi.Path, err)
// 	}
...
// func (e *AudioExtractor) Extract(ctx context.Context, fi source.FileInfo) ([]*job, error) {
// 	data, err := e.Reader.Read(ctx, fi.Path)
// 	if err != nil {
// 		return nil, fmt.Errorf("read %s: %w", fi.Path, err)
// 	}
...
// 	audioItemID, err := store.UpsertItem(ctx, fileID, model.Item{
// 		ItemType:    "audio",
// 		ItemName:    fi.Name,
// 		MimeType:    "audio/wav",
// 		Size:        int64(len(data)),
...
// func (e *VideoExtractor) Extract(ctx context.Context, fi source.FileInfo) ([]*job, error) {
// 	data, err := e.Reader.Read(ctx, fi.Path)
// 	if err != nil {
// 		return nil, fmt.Errorf("read %s: %w", fi.Path, err)
// 	}
...
// 				frameItemID, err := store.UpsertItem(ctx, fileID, model.Item{
// 					ItemType:  "frame",
...
// func (e *EmailExtractor) Extract(ctx context.Context, fi source.FileInfo) ([]*job, error) {
// 	data, err := e.Reader.Read(ctx, fi.Path)
// 	if err != nil {
// 		return nil, fmt.Errorf("read %s: %w", fi.Path, err)
// 	}
